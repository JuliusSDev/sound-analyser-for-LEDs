...
class SoundAnalyser{
    ...
    private:
        ...
        static void analizeSamples(const SAMPLE* samplesBuffer);  //TODO have to be a thread which will have while(1) loop?, at the end of the loop thread will be blocked. recordCallback will unblockthread and update information(samplesBuffer)in it
