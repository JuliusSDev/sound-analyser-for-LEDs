...
//sound light defines
#define BRIGHTNESS_THRESHOLD (150)  //Used to be 150
#define DIFFERENT_MIN_MAX_FOR_DARKNESS (3)  // Used to be 3 - is ok
// #define NO_FULL_DARKNESS
#define ONLY_BASS_LIGHT

class BluetoothCommunicator : public CommunicatorI{
    public:
